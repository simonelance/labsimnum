...
public: // Function declarations
  ...
  void initialize_properties(const string);// Initialize properties for measurement
  ...
  void write_velocities(); // write particles velocities in xyz format in the output file: 'velocities.xyz
  ...
  void averages(int blk, const string);     // Compute averages of properties
