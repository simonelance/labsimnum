...
public: // Function declarations
  ...
  void Update_temp(double);
  void Set_restart(bool );
  void block_reset(int);      // Reset block averages
  void temp_reset(double );
  void measure();             // Measure properties of the system
  void averages(int blk, const string, const string);     // Compute averages of properties
